...
contract ITokenActionValidator
{
    ...
    function setAuthDataOK(address _caller, ITokenActionValidator _validator,  address _authedForwarder) returns (bool success)
    {
        return true;
    }
}
...
library StandardZipperTokenFunctionality
{
  ...
  function setAuthData(data storage self, ITokenActionValidator _newvalidator, address _authedForwarder) returns (bool success)
  {
...
contract StandardZipperToken is Zipper_ERC20 {
  ...
  function StandardZipperToken(ITokenActionValidator _validator, address _authedForwarder)
  {
  ...
  function transferAuthed(address caller, address to, uint value) returns (bool ok)
  {
    if (msg.sender != data.authedForwarder)
      return false;
  ...
  /* maintainence */
  function setAuthData(ITokenActionValidator _newvalidator, address _authedForwarder) returns (bool success)
  {
...
contract SimpleIssuerToken is StandardZipperToken
{
    ...
    function SimpleIssuerToken(address _issuer, ITokenActionValidator _validator, address _authedForwarder) 
